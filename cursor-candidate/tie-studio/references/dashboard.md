...
```bash
python3 "$TIE_SKILL_ROOT"/scripts/tie_dashboard.py validate \
  --project /path/to/project --view /path/to/view.json
python3 "$TIE_SKILL_ROOT"/scripts/tie_dashboard.py publish \
  --project /path/to/project --session main --view /path/to/view.json
python3 "$TIE_SKILL_ROOT"/scripts/tie_dashboard.py serve \
  --project /path/to/project --session main
python3 "$TIE_SKILL_ROOT"/scripts/tie_dashboard.py status \
  --project /path/to/project --session main
python3 "$TIE_SKILL_ROOT"/scripts/tie_dashboard.py stop \
  --project /path/to/project --session main
```
