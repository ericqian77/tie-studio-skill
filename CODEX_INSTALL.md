...
hosted model API. This guide supplies the Codex adaptation. For Cursor, use [the separate guide](cursor/START_HERE.md).

## Install in a disposable project

1. Clone the pinned Codex snapshot (Git access is required only while the repository is private)
